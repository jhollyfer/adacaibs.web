  ...
  .union([
    z.string().transform((str) =>
      str
        ...
        .filter((presenter) => presenter.length > 0)
    ),
    z.array(z.string()),
  ]),
guests: z
...
export const PodcastTransformedSchema = PodcastSchema.create.transform((data) => ({
  ...data,
...
export type PodcastCreatePayload = z.infer<
  (typeof PodcastSchema)["create"]
>
export type PodcastUpdatePayload = z.infer<
  (typeof PodcastSchema)["update"]
>