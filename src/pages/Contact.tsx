        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Rua das Flores, 123 - Centro<br />Cidade - Estado, CEP 00000-000</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-4 bg-gray-100 rounded-lg">
              <h3 className="font-medium mb-2">Precisa de um intérprete de LIBRAS?</h3>
              <p className="text-gray-700 mb-4">
                Oferecemos serviços de interpretação em LIBRAS para eventos, reuniões e outras ocasiões. Entre em contato para mais informações.
              </p>
