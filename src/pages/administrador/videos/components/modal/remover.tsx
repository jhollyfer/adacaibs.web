...
import { removeVideoFromPagination } from "@/lib/tanstack/actions/videos";
import { useVideoRemoveMutation } from "@/lib/tanstack/mutation/videos/remove";
...
export function Remove({
  ...
  const remover = useVideoRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removeVideoFromPagination(
        {
          id,
        },
        {
