...
import { removePodcastFromPagination } from "@/lib/tanstack/actions/podcast";
import { usePodcastRemoveMutation } from "@/lib/tanstack/mutation/podcast/remove";
...
export function Remove({
  ...
  const remover = usePodcastRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removePodcastFromPagination(
        {
          id,
        },
        {
