...
import { removeUserFromPagination } from "@/lib/tanstack/actions/usuarios";
import { useUserRemoveMutation } from "@/lib/tanstack/mutation/usuario/remove";
...
export function Remove({
  ...
  const remover = useUserRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removeUserFromPagination(
        {
          id,
        },
        {
