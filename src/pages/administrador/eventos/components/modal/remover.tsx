...
import { removeEventFromPagination } from "@/lib/tanstack/actions/eventos";
import { useEventRemoveMutation } from "@/lib/tanstack/mutation/eventos/remove";
...
export function Remove({
  ...
  const remover = useEventRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removeEventFromPagination(
        {
          id,
        },
        {
