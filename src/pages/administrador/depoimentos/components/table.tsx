...
export function Table({ data, labels }: Props): React.ReactElement {
  ...
  return (
    <React.Fragment>
          ...
          {data.map((row) => {
            return (
              <TableRow key={row.id}>
                ...
                <TableCell>
                  <p className="line-clamp-2 max-w-xs">{row.testimonial}</p>
                </TableCell>
                    ...
                    <DropdownMenuContent className="mr-10">
                      ...
                      <DropdownMenuItem
                        ...
                        onClick={() => {
                          ...
                          // Poderia abrir uma visualização do depoimento
                        }}
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        onClick={() => {
                          ...
                          testimonialUpdateButtonRef?.current?.click();
                        }}
                      >
      ...
      <Sheet.Update ref={testimonialUpdateButtonRef} />
    </React.Fragment>
  );
}
