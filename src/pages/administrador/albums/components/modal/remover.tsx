...
import { removeAlbumFromPagination } from "@/lib/tanstack/actions/albums";
import { useAlbumRemoveMutation } from "@/lib/tanstack/mutation/albums/remove";
...
export function Remove({
  ...
  const remover = useAlbumRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removeAlbumFromPagination(
        {
          id,
        },
        {
