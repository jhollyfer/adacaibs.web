...
import { removeNoticeFromPagination } from "@/lib/tanstack/actions/noticias";
import { useNoticeRemoveMutation } from "@/lib/tanstack/mutation/noticias/remove";
...
export function Remove({
  ...
  const remover = useNoticeRemoveMutation({
    onError(error) {
      console.error(error);
    },
    onSuccess() {
      removeNoticeFromPagination(
        {
          id,
        },
        {
