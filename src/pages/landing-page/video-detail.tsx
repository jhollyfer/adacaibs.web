...
const mockVideo = {
  ...
  content: `
    <p>Este vídeo tutorial é ideal para quem está começando a aprender Comunicação e deseja conhecer as expressões mais básicas e utilizadas no dia a dia.</p>
    
    <p>Nossa instrutora Ana Beatriz, surda e professora de Comunicação há mais de 10 anos, guiará você pelos primeiros passos nesta língua tão rica e expressiva.</p>
    ...
    <ul>
      ...
      <li>A importância das expressões faciais na comunicação em Comunicação</li>
    </ul>
    
    <p>Este é o primeiro vídeo de nossa série "Aprenda Comunicação", que tem como objetivo tornar a Língua Brasileira de Sinais acessível a todos, contribuindo para uma sociedade mais inclusiva e conectada.</p>
  `,
...
export function VideoDetail(): React.JSX.Element {
