...
const mockNews = [
  ...
  },
  {
    ...
    excerpt:
      "Workshop gratuito de LIBRAS oferecido pela associação contou com mais de 50 participantes.",
  ...
  },
  {
    ...
    excerpt:
      "Nova parceria permitirá levar oficinas de LIBRAS a todas as escolas municipais a partir do próximo semestre.",
