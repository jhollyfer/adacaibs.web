...
const mockEvent = {
  ...
  content: `
    ...
    <p>A ADACAIBS promoverá um workshop introdutório de Língua Brasileira de Sinais (LIBRAS), destinado a pessoas que desejam iniciar seus estudos nesta língua tão importante para a comunicação com a comunidade surda.</p>
    ...
    <p>O workshop será ministrado por professores surdos fluentes em LIBRAS e contará com o apoio de intérpretes para garantir a comunicação eficaz com todos os participantes.</p>
    
    <p>Não é necessário ter conhecimento prévio em LIBRAS. O workshop é destinado a iniciantes e abordará os conceitos básicos da língua de forma didática e interativa.</p>
            ...
            <div className="flex justify-center mb-8">
              <Dialog>
                ...
                <DialogContent>
                  ...
                  <EventRegistrationForm eventTitle={mockEvent.title} />
                </DialogContent>
              </Dialog>
            </div>
          )}
